...
@wget --no-check-certificate https://raw.github.com/CoRfr/oh-my-zsh/master/tools/install.sh -O - | sh@
...
@curl -L https://raw.github.com/CoRfr/oh-my-zsh/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/CoRfr/oh-my-zsh.git ~/.oh-my-zsh@
