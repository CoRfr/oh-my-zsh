...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/CoRfr/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget -O- https://raw.githubusercontent.com/CoRfr/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
curl -Lo install.sh https://raw.githubusercontent.com/CoRfr/oh-my-zsh/master/tools/install.sh
sh install.sh
```
...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/CoRfr/ohmyzsh/master/tools/install.sh)" "" --unattended
```
...
```shell
git clone https://github.com/CoRfr/ohmyzsh.git ~/.oh-my-zsh
```
